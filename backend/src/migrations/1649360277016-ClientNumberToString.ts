...
export class ClientNumberToString1649360277016 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client" ADD "postalCode" character varying NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client" DROP COLUMN "postalCode"`);
        await queryRunner.query(`ALTER TABLE "client" ADD "postalCode" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "document" ADD "client" character varying`);
    }
